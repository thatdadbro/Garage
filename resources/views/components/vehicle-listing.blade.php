...
<div class="bg-white rounded-lg shadow-md p-6 mb-4 flex items-center">
    ...
    @endphp
    <div>
        <img src="{{ asset($imagePath) }}" alt="Image of {{ $vehicle->name }}" width="250px" style="padding-right:2rem;">
    </div>
    <div class="flex items-top">
      <div style="margin-right:1.5rem; padding-right:1.5rem; border-right:1px solid #ddd;">
